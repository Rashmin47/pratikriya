  ...
  return (
    <div className="space-y-12">
      <GradientHeader
        ...
        subtitle="Pratikriya is where your ideas come to life. Suggest features"
      >
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Share your suggestions and opinions with the community
              </p>
            </CardContent>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Follow our public roadmap to see what we&#39;re working on
                next.{" "}
              </p>
            </CardContent>
          </Card>
